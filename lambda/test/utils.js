...
describe('utils', () => {
    describe('#calculateFromToDateKeys()', () => {
        it('should default to null/null when no slot value given', () => {
            ...
            const result = utils.calculateFromToDateKeys(slots);
        ...
        it("should use last week for tomorrow's date", () => {
            ...
            const result = utils.calculateFromToDateKeys(slots, moment('2018-08-09'));
        ...
        it("should use last week for tomorrow's date across years", () => {
            ...
            const result = utils.calculateFromToDateKeys(slots, moment('2019-01-01'));
        ...
        it('should use previous year for future date', () => {
            ...
            const result = utils.calculateFromToDateKeys(slots, moment('2018-08-10'));
        ...
        it('should work with this weekend on Saturday', () => {
            const slots = { date: { name: 'date', value: '2018-W31-WE' } };
            const result = utils.calculateFromToDateKeys(slots, moment('2018-08-04'));
            expect(result).to.include({ fromDate: '2018-08-04', toDate: '2018-08-05' });
        });

        it('should work with this weekend on Sunday', () => {
            const slots = { date: { name: 'date', value: '2018-W31-WE' } };
            const result = utils.calculateFromToDateKeys(slots, moment('2018-08-05'));
            expect(result).to.include({ fromDate: '2018-08-04', toDate: '2018-08-05' });
        });
        ...
        it('should work with 1st weekend of year', () => {
            ...
            const result = utils.calculateFromToDateKeys(slots, moment('2019-01-09'));
        ...
        it('should work with 1st week of year', () => {
            ...
            const result = utils.calculateFromToDateKeys(slots, moment('2019-01-08'));
        ...
        it('should work with 2021-W2', () => {
            ...
            const result = utils.calculateFromToDateKeys(slots, moment('2021-01-15'));
    ...
    describe('#calculateDateKey()', () => {
        it('should default to today when no slot value given', () => {
            const slots = { date: { name: 'date' } };
            const result = utils.calculateDateKey(slots);
        ...
        it('should give different results for today across timezones', () => {
            const slots = { date: { name: 'date' } };
            const resultTZMinus12 = utils.calculateDateKey(slots, moment().tz('Etc/GMT+12')); // Sign is intentionally inverted. See https://en.wikipedia.org/wiki/Tz_database#Area
            const resultTZPlus12 = utils.calculateDateKey(slots, moment().tz('Etc/GMT-12')); // Sign is intentionally inverted. See https://en.wikipedia.org/wiki/Tz_database#Area
        ...
        it("should use last week for tomorrow's date", () => {
            const slots = { date: { name: 'date', value: '2018-08-10' } };
            const result = utils.calculateDateKey(slots, moment('2018-08-09'));
            expect(result).to.equal('2018-08-03');
        });

        it("should use last week for tomorrow's date across years", () => {
            const slots = { date: { name: 'date', value: '2019-01-06' } };
            const result = utils.calculateDateKey(slots, moment('2019-01-01'));
        ...
        it('should use previous year for future date', () => {
            ...
            // yesterday's date, Alexa gives 2019-04-02 as slot value.
            const slots = { date: { name: 'date', value: '2019-08-09' } };
            const result = utils.calculateDateKey(slots, moment('2018-08-10'));
