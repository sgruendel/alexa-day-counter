...
describe('Testing a session with the IncreaseCounterIntent (NaN):', () => {
    ...
    describe('The response', () => {
        ...
        it('should have a spoken response', () => {
            ...
            expect(speechResponse.response.outputSpeech.ssml).to.contain('kein Wert');
        });
    ...
    describe('The db', () => {
        it('should have a count of 0', () => {
            return expect(db.find(USER_ID, TODAY)).to.eventually.have.property('count', 0);
        });
    });
});
