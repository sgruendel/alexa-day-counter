...
describe('Testing a session with the QueryCounterIntent (month given):', () => {
    ...
    describe('The response', () => {
        ...
        it('should have a spoken response', () => {
            ...
            expect(speechResponse.response.outputSpeech.ssml).to.contain(DATE + '-01');
            expect(speechResponse.response.outputSpeech.ssml).to.contain(DATE + '-31');
        });
