...
describe('Testing a session with the IncreaseCounterIntent (no date given):', () => {
    var speechResponse = null;
    var speechError = null;

    before(function() {
        return db.insert(USER_ID, TODAY, 6)
            .then(() => {
    ...
    describe('The db', () => {
        it('should have a count of 7', () => {
            return expect(db.find(USER_ID, TODAY)).to.eventually.have.property('count', 7);
        });
    });
});
